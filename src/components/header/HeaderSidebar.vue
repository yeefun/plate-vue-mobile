<template>
  <section class="header-sidebar">
    <button class="header-sidebar__close" @click="closeSidebar()"><img src="/assets/mirrormedia/icon/close_white@2x.png" :alt="$t('HEADER.CLOSE')" data-gtm="menu close" data-gtm-category="header"></button>
    ...
    <div class="sections">
      ...
      <div class="section mirrorfiction">
        <a href="https://www.mirrorfiction.com/" class="link--external mirrorfiction" @click="sendGaClickEvent('header', `section mirrorfiction`)" target="_blank" v-text="$t('HEADER.MIRRORFICTION')"></a>
      </div>
      <div class="section">
        <a href="https://www.readr.tw/" class="link--external readr" @click="sendGaClickEvent('header', `section readr`)" target="_blank" v-text="$t('HEADER.READR')"></a>
      </div>
    </div>
    <div class="others">
