<template>
  <footer class="footer-foodtravel">
    ...
    <div class="footer-foodtravel__menu">
      <a :href="item.href" v-for="(item, i) in menuItem.section" v-text="item.title" :id="'footer-' + item.href" :key="`${i}-${Date.now()}`" @click="sendGaClickEvent('footer', `footer ${item.name}`)"></a>
      <a :href="item.href" v-for="(item, i) in menuItem.category" v-text="item.title" :id="'footer-' + item.href" :key="`${i}-${Date.now()}`" @click="sendGaClickEvent('footer', `footer ${item.name}`)"></a>
    </div>
