<template>
  <footer class="footer-foodtravel">
    ...
    <div class="footer-foodtravel__menu">
      <router-link :to="item.href" v-for="(item, i) in menuItem.section" v-text="item.title" :id="'footer-' + item.href" :key="`${i}-${Date.now()}`" @click.native="sendGaClickEvent('footer', `footer ${item.name}`)"></router-link>
      <router-link :to="item.href" v-for="(item, i) in menuItem.category" v-text="item.title" :id="'footer-' + item.href" :key="`${i}-${Date.now()}`" @click.native="sendGaClickEvent('footer', `footer ${item.name}`)"></router-link>
    </div>
